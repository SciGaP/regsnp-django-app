...
module.exports = {
  publicPath:
    process.env.NODE_ENV === "development"
      ? "http://localhost:9000/static/django_airavata_summary/dist/"
      : "/static/django_airavata_summary/dist/",
  outputDir: "./static/django_airavata_summary/dist",
  pages: {
    "project-list": "./static/django_airavata_summary/js/entry-project-list",
    dashboard: "./static/django_airavata_summary/js/entry-dashboard",
    "create-experiment":
      "./static/django_airavata_summary/js/entry-create-experiment",
    "view-experiment":
      "./static/django_airavata_summary/js/entry-view-experiment",
    "experiment-list":
      "./static/django_airavata_summary/js/entry-experiment-list",
    "edit-experiment":
      "./static/django_airavata_summary/js/entry-edit-experiment",
    "edit-project": "./static/django_airavata_summary/js/entry-edit-project",
    "user-storage": "./static/django_airavata_summary/js/entry-user-storage",
  },
  css: {
    loaderOptions: {
      postcss: {
  ...
  configureWebpack: {
    plugins: [
      new BundleTracker({
        ...
        path: "./static/django_airavata_summary/dist/",
      }),
    ],
    optimization: {
      /*
