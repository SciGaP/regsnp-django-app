...
def experiments_list(request):
    ...
    return render(request, 'django_airavata_summary/experiments_list.html', {
...
def dashboard(request):
    ...
    return render(request, 'django_airavata_summary/dashboard.html', {
...
def projects_list(request):
    ...
    return render(request, 'django_airavata_summary/projects_list.html', {
...
def edit_project(request, project_id):
    ...
    return render(request, 'django_airavata_summary/edit_project.html', {
...
def create_experiment(request, app_module_id):
    ...
    return render(request,
                  'django_airavata_summary/create_experiment.html',
                  context)
...
def edit_experiment(request, experiment_id):
    ...
    return render(request,
                  'django_airavata_summary/edit_experiment.html',
...
def view_experiment(request, experiment_id):
    ...
    return render(request, 'django_airavata_summary/view_experiment.html', {
...
def user_storage(request):
    ...
    return render(request, 'django_airavata_summary/base.html', {
