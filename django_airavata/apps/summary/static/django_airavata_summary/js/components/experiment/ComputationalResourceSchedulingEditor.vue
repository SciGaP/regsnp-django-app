...
export default {
  ...
  methods: {
    ...
    loadWorkspacePreferences() {
      return services.WorkspacePreferencesService.get().then(
        (summaryPreferences) =>
          (this.summaryPreferences = summaryPreferences)
      );
    },
  ...
  watch: {
    computeResourceOptions: function (newOptions) {
      ...
      if (
        this.resourceHostId === null &&
        this.summaryPreferences.most_recent_compute_resource_id &&
        newOptions.find(
          (opt) =>
            opt.value ===
            this.summaryPreferences.most_recent_compute_resource_id
        ...
        this.resourceHostId = this.summaryPreferences.most_recent_compute_resource_id;
      }
